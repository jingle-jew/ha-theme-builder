...
const paths: Record<string, SVGTemplateResult> = {
  ...
  image: svg`<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="9" cy="10" r="2"/><path d="m21 15-5-5L5 20"/>`,
  layers: svg`<path d="m12 3 9 5-9 5-9-5 9-5Z"/><path d="m3 12 9 5 9-5M3 16l9 5 9-5"/>`,
  type: svg`<path d="M5 5h14M12 5v14M8 19h8"/>`,
  sidebar: svg`<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 3v18M5.5 7h1M5.5 11h1"/>`,
